...
public:
    ...
    ll get_first(int v, int tl, int tr, int l, int r, int x) {
    ...
    while(t--){
        ...
        for(int i=0;i<m;i++){
            ...
            if(x==sum){
                ...
                cout<<st.get_first(1,0,n-1,0,n-1,x)<<" ";
            }else{
                int v=x/sum;
                if(x%sum==0){
                    cout<<n*v -1<<" ";
                }else{
                    cout<<n*v +st.get_first(1,0,n-1,0,n-1,x%sum)<<" ";
                }
                // cout<<v<<" ++ "<<endl;
            }
        }

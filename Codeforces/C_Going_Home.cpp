        ...
        //mamuli int passes
          ...
          for(int i=0;i<n;i++){
            for(int j=i+1;j<n;j++){
                ...
                if(fre[sum].first!=fre[sum].second){
                    if(fre[sum].first==i ||fre[sum].first==j ||fre[sum].second ==i || fre[sum].second==j)continue;
                    v3=fre[sum].first,v4=fre[sum].second,v1=i,v2=j;
                    anse=true;break;
                }
                fre[sum]={i,j};
            }
